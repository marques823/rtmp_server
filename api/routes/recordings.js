 ...
 */
router.get('/:streamName', isAuthenticated, (req, res) => {
  try {
 ...
 * @apiParam {String} streamName Nome do stream/câmera
 */
router.post('/:streamName/start', isAuthenticated, (req, res) => {
  try {
    const { streamName } = req.params;
 ...
 * @apiParam {String} streamName Nome do stream/câmera
 */
router.post('/:streamName/stop', isAuthenticated, (req, res) => {
  try {
    const { streamName } = req.params;
 ...
 */
router.delete('/:streamName/:filename', isAuthenticated, (req, res) => {
  try {
